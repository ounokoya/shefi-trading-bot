...
class CCI1h4hTf5mBrain(BaseBrain):
    """
    Double CCI Brain (1H + 4H on 5m Data):
    - CCI Fast: 1H (Length 12)
    - CCI Slow: 4H (Length 48)
    ...
    def __init__(self, source_df: pd.DataFrame, source_tf: str = "5m", filter_mode: str = "none"):
        ...
        # Precompute CCIs
        self.cci_fast_series = self._compute_cci(length=12)
        self.cci_slow_series = self._compute_cci(length=48)
