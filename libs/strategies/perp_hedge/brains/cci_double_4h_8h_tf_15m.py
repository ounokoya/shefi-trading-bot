...
class CCIDouble4h8hTf15mBrain(BaseBrain):
    """
    Double CCI Brain (4H + 8H on 15m Data):
    - Resamples 5m source data to 15m.
    - CCI Fast: 4H (Length 16 on 15m)
    - CCI Slow: 8H (Length 32 on 15m)
    ...
    def __init__(self, source_df: pd.DataFrame, source_tf: str = "5m", filter_mode: str = "none"):
        ...
        self.cci_fast_series = self._compute_cci(self.df_15m, length=16)
        self.cci_slow_series = self._compute_cci(self.df_15m, length=32)
