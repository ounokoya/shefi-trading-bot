...
class CCI8hTf15mBrain(BaseBrain):
    """
    CCI 8H Brain (on 15m Data):
    - Resamples 5m source data to 15m.
    - Calculates CCI(32) on 15m data (32 * 15m = 8 Hours).
    ...
    def __init__(self, source_df: pd.DataFrame, source_tf: str = "5m", filter_mode: str = "none"):
        ...
        # 2. Compute CCI(32) on 15m
        self.cci_series_15m = self._compute_cci(self.df_15m, length=32)
