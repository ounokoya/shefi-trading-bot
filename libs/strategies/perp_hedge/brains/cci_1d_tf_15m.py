...
class CCI1dTf15mBrain(BaseBrain):
    """
    CCI 1D Brain (on 15m Data):
    - Resamples 5m source data to 15m.
    - Calculates CCI(96) on 15m data (96 * 15m = 24 Hours).
    ...
    def __init__(self, source_df: pd.DataFrame, source_tf: str = "5m", filter_mode: str = "none"):
        ...
        # 2. Compute CCI(96) on 15m
        self.cci_series_15m = self._compute_cci(self.df_15m, length=96)
