...
class CCI8hTf5mBrain(BaseBrain):
    """
    CCI 8H Brain (on 5m Data):
    - Calculates CCI(96) on the source timeframe (5m).
    - Optional Klinger Filter.
    """
    def __init__(self, source_df: pd.DataFrame, source_tf: str = "5m", cci_length: int = 96, filter_mode: str = "none"):
